  ...
  return (
    <>
      ...
      <section className="section-pad">
        <div className="container about-founder-grid about-founder-grid-clean">
          <div className="about-profile-column">
            ...
            <div className="credential-card credential-card-clean" aria-label="Quinn Posner credentials">
              <p className="credential-lead">Quinn Posner | Landlord-Side Eviction Counsel</p>
              <div className="credential-list">
                {credentials.map((credential) => (
                  <p className="credential-line" key={credential}>{credential}</p>
                ))}
              </div>
            </div>
          </div>
          <article className="about-copy-panel about-copy-clean">
            ...
            <div className="founder-story-prose">
              <p>Quinn Posner saw a legal industry still operating on outdated assumptions: hourly billing, slow handoffs, and a billing-first culture that often made legal services harder for clients to use than they needed to be.</p>
              <p>His pivot into landlord-side work came from a professional conclusion. Landlord-tenant law has repeatable patterns, repeatable documents, and repeatable decision points. Those patterns can be organized through better systems, clearer workflows, and technology that gives property managers real visibility into what is happening with their matters.</p>
              <p>A brief personal reset gave him room to build the model deliberately, but the focal point was the professional opportunity in front of him. In 2019, he launched NW Landlord Solutions to operate more like a legal technology product than a traditional law firm.</p>
              <p>The firm is built around flat-fee pricing, clear workflows, real-time visibility, and a partnership model. The goal is not to be a vendor that sells time. The goal is to be an operating partner that helps property managers move work with less uncertainty.</p>
